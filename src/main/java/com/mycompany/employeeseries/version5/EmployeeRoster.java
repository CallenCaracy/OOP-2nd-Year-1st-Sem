...
public class EmployeeRoster {
    ...
    public void displayHE(){
        if(this.empList.size() > 0){
            for(int i = 0; i < empList.size(); i++){
                if(this.empList.get(i) instanceof HourlyEmployee){
                    ((HourlyEmployee)this.empList.get(i)).displayHourlyEmployee();
                }else{
                    continue;
                }
            }
        ...
        if(this.empList.size() > 0){
            for(int i = 0; i < empList.size(); i++){
                if(this.empList.get(i) instanceof CommissionEmployee){
                    ((CommissionEmployee)this.empList.get(i)).displayCommissionEmployee();
                }else{
                    continue;
                }
            }
    ...
    public void displayBPCE(){
        if(this.empList.size() > 0){
            for(int i = 0; i < empList.size(); i++){
                if(this.empList.get(i) instanceof BasedPlusCommissionEmployee){
                    ((BasedPlusCommissionEmployee)this.empList.get(i)).displayBasedPlusCommissionEmployee();
                }else{
                    continue;
                }
            }
    ...
    public void displayPWE(){
        if(this.empList.size() > 0){
            for(int i = 0; i < empList.size(); i++){
                if(this.empList.get(i) instanceof PieceWorkerEmployee){
                    ((PieceWorkerEmployee)this.empList.get(i)).displayPieceWorkerEmployee();
                }else{
                    continue;
                }
            }
